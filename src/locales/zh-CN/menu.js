export default {
  ...
  'menu.jewelbox': '百宝箱',
  'menu.jewelbox.rap2code': 'Rap2Code',
  'menu.jewelbox.rap2code.info': '分步表单（填写转账信息）',
  'menu.jewelbox.rap2code.confirm': '分步表单（确认转账信息）',
  'menu.jewelbox.rap2code.result': '分步表单（完成）',
  'menu.jewelbox.tabdemo': 'Tab页签',
  'menu.jewelbox.tabdemo.articles': '搜索列表（文章）',
  'menu.jewelbox.tabdemo.projects': '搜索列表（项目）',
  'menu.jewelbox.tabdemo.applications': '搜索列表（应用）',
  'menu.form': '表单页',
